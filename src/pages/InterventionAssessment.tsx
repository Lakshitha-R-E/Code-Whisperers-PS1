...
import {
  Award, Filter, ShieldCheck, Building2, Info, RefreshCw,
} from 'lucide-react';
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-primary-50 border border-primary-200 rounded-lg p-3.5 flex items-start gap-3">
        ...
        <div className="text-xs text-primary-800 leading-relaxed">
          <span className="font-semibold">Methodology Transparency:</span> Effectiveness scores are computed from each structure's type, completion percentage, and age using a transparent rule-based formula (type-specific baseline impact rates × completion factor × an age-based maturation curve), not fixed example numbers. The baseline rates reflect typical NDVI-greening and Sentinel-1 soil-moisture-enhancement magnitudes reported for each structure type in watershed literature — this page does not call live per-project satellite imagery for each structure. For live, site-specific satellite readings, use Impact Simulation or Geo Image Intelligence, which do query Earth Engine directly for a clicked location.
        </div>
      </div>
